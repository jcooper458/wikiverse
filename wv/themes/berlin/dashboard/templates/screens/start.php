...
<div class="infinity-content">
		<h2>Thank you for purchasing Berlin!</h2>
 		
 		<p>
 		Thank you for purchasing Berlin! We are glad to welcome you to our community and have you as a customer. We advise you to read the documentation included with this theme to quickly help you get started. Simply navigate to the "Documentation" tab and you'll be presented with a detailled set up guide.
 		</p>	
...
Please submit your <strong>installation details</strong> when you create a support topic. They are displayed in the sidebar >>
	...
	BuddyPress Support: <a href="http://buddypress.org/support/">BuddyPress Support</a><br>
		...
		$rss = fetch_feed('http://community.presscrew.com/discussion/premium-themes/berlin/feed');
