<select id="langselect" name="input" class="selectpicker pull-right show-menu-arrow" data-size="10" data-width="100%" data-style="btn btn-default" data-live-search="true">
