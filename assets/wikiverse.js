...
exports.getFlickrUsername = exports.searchResultsListBuilt = exports.getWikis = exports.getSoundclouds = exports.getFlickrs = exports.getInstagrams = exports.getRelatedYoutubes = exports.getYoutubes = exports.getTweets = undefined;
...
var getInstagrams = exports.getInstagrams = function getInstagrams(query, type, dataLoaded, triggerSearchResultsFunction) {
    ...
    if (type === "coordinates") {
        ...
        _jquery2.default.getJSON(instagramUrl, access_parameters, function (data) {
                ...
                if (typeof data.data !== 'undefined' && data.data.length > 0) {
                    ...
                    data.data.map(function (user, index) {
                        ...
                        if (user.username === query) {
                            ...
                            _jquery2.default.getJSON(getUserUrl, access_parameters, function (data) {
...
var searchResultsListBuilt = exports.searchResultsListBuilt = function searchResultsListBuilt($results) {
    ...
    $results.find('.result').unbind('click').on('click', function (event) {
        ...
        var result = (0, _jquery2.default)(this).data("topic");
        ...
        (0, _jquery2.default)(this).tooltip('destroy');
...
var _getFunctions = require('./getFunctions.js');
...
window.WIKIVERSE = (function ($) {
    ...
    wikiverse.init = function () {
        ...
        $(".source").on("click", function () {
            ...
            wikiverse[functionToBuildSearchResults](thisResultsArray, _getFunctions.searchResultsListBuilt);
            $sourceType.trigger('change');
        });
    ...
    var searchResultsLoaded = function searchResultsLoaded(results, source, triggerSearchResultsFunction) {
        ...
        if (results.length > 0) {
            ...
            if (triggerSearchResultsFunction) {
                wikiverse[triggerSearchResultsFunction](results, _getFunctions.searchResultsListBuilt);
            }
        } else {
    ...
    var isPortrait = function isPortrait(imgElement) {
    ...
    var getGmapsFotos = function getGmapsFotos($mapsBrick) {
        ...
        $mapsBrick.find('.getFotos').on('click', function () {
            ...
            if ($(this).attr('id') === "Instagram") {
                (0, _getFunctions.getInstagrams)(position, "coordinates", searchResultsLoaded, "buildFotoSearchResults");
            } else {
                (0, _getFunctions.getFlickrs)(position, "relevance", "geoQuery", searchResultsLoaded, "buildFotoSearchResults");
            }
        });
    };
    ...
    var getConnections = function getConnections(source, topic, parent) {
        ...
        switch (source) {
            ...
            case "Flickr":
                (0, _getFunctions.getFlickrs)(topic, wikiverse.flickrSortType, wikiverse.flickrSearchType, searchResultsLoaded, "buildFotoSearchResults");
                break;

            case "Instagram":
                //remove whitespace from instagram query
                (0, _getFunctions.getInstagrams)(topic.replace(/ /g, ''), wikiverse.instagramSearchType, searchResultsLoaded, "buildFotoSearchResults");
                break;

            case "Youtube":
                (0, _getFunctions.getYoutubes)(topic, wikiverse.youtubeSortType, wikiverse.searchLang, searchResultsLoaded, "buildYoutubeSearchResults");
                break;

            case "Soundcloud":
                (0, _getFunctions.getSoundclouds)(topic, searchResultsLoaded, "buildListResults");
                break;

            case "Twitter":
                (0, _getFunctions.getTweets)(topic, wikiverse.twitterSearchType, wikiverse.searchLang, searchResultsLoaded, "buildTwitterSearchResults");
                break;

            case "Wikipedia":
                (0, _getFunctions.getWikis)(topic, wikiverse.searchLang, searchResultsLoaded, "buildListResults");
                break;
        }
    };
    ...
    wikiverse.buildFoto = function ($brick, photoObj, type, callback) {
        ...
        if (type === "Flickr") {
            ...
            (0, _getFunctions.getFlickrUsername)(photoObj.owner, function (username) {
    ...
    wikiverse.buildTwitterSearchResults = function (results) {
        ...
        (0, _getFunctions.searchResultsListBuilt)($results);
    };
    ...
    //create a note
    var createNote = function createNote($brick, callback) {
    ...
    wikiverse.buildYoutube = function ($brick, youtubeObj, callback) {
        ...
        $brick.find('.related').on('click', function () {
            (0, _getFunctions.getRelatedYoutubes)(youtubeObj.youtubeID, youtubeObj.query, searchResultsLoaded, "buildYoutubeSearchResults", $brick.data('id'));
            $sourceType.trigger('change');
        });
    ...
    $('.search input').keyup(function (e) {
        ...
        if (e.keyCode === 13) {
            ...
            (0, _getFunctions.getWikis)(query, "en", searchResultsLoaded);
            (0, _getFunctions.getSoundclouds)(query, searchResultsLoaded);
            (0, _getFunctions.getTweets)(query, "popular", "en", searchResultsLoaded);
            (0, _getFunctions.getYoutubes)(query, "relevance", "en", searchResultsLoaded);
            (0, _getFunctions.getFlickrs)(query, "relevance", "textQuery", searchResultsLoaded);
            (0, _getFunctions.getInstagrams)(query, "hashtag", searchResultsLoaded);
